...
function addRouteSourcesAndLayers(map) {
  ...
  if (!map.getSource('completed-routes')) {
    ...
    map.addLayer({ id: 'completed-routes-tube-shadow', type: 'line', source: 'completed-routes', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#02050a', 'line-width': ['*', widthExpr('width'), 0.58], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.26]], 'line-blur': 0.45, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], 0.72] } });
    ...
    map.addLayer({ id: 'completed-routes-sheen', type: 'line', source: 'completed-routes', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#ffffff', 'line-width': ['*', widthExpr('width'), 0.42], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.34]], 'line-blur': 0.42, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -0.78] } });
    map.addLayer({ id: 'completed-routes-rim-light', type: 'line', source: 'completed-routes', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': ['case', ['==', ['get', 'trailRole'], 'border'], 'transparent', '#dff7ff'], 'line-width': ['*', widthExpr('width'), 0.14], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.52]], 'line-blur': 0.18, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], -1.16] } });
  }
  if (!map.getSource('active-route')) {
    ...
    map.addLayer({ id: 'active-route-tube-shadow', type: 'line', source: 'active-route', layout: { 'line-cap': 'round', 'line-join': 'round' }, paint: { 'line-color': '#02050a', 'line-width': ['*', widthExpr('width'), 0.62], 'line-opacity': ['*', opacityExpr('opacity'), ['case', ['==', ['get', 'trailRole'], 'border'], 0, ['==', ['get', 'trailRole'], 'separator'], 0, 0.34]], 'line-blur': 0.46, 'line-offset': ['+', ['coalesce', ['get', 'lineOffset'], 0], 0.76] } });
